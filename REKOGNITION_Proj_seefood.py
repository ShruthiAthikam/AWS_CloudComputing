...
def label_image(img, confidence=50):
    ...
    for str in lbls:
        if str == 'Hot Dog':
            ...
            isFood = True
    if isHotDog:
        return add_text_to_img(pimg, 'Hot Dog', pos=(275, 0), color=(255, 255, 255), bgcolor=(0, 255, 0))
    if not isHotDog and isFood:
        return add_text_to_img(pimg, 'Not Hot Dog', pos=(150,650), color=(255, 255, 255), bgcolor=(255,0, 0))
    if not isFood:
        return add_text_to_img(pimg, 'Not Food', pos=(800,850), color=(255, 255, 255), bgcolor=(255, 0, 0))
    pass
...
if __name__ == "__main__":
    ...
    #img = 'http://www.idothat.us/images/idothat-img/features/pool-patio-lanai/ft-pool-patio-lanai-2.jpg'
